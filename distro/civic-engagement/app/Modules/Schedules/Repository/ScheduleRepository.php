...
class ScheduleRepository extends BaseRepository
{
    ...
    /**
     * Search public schedules for the shared Civic search experience.
     *
     * This intentionally searches only public-facing fields and includes both
     * active and archived public schedules.
     *
    ...
    public function searchPublic(string $keyword, array $args = []): array
    {
        ...
        $pagination = $this->parsePaginationArgs($args);
        $where = $this->buildScheduleFilters($args);
        $search = $this->buildSearchClause($keyword, ['title', 'slug', 'details', 'recent_update', 'type', 'status']);
